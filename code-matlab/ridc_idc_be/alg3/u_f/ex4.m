...
%   Consider the following homogenious heat equation:

%    u_t=epsilon*u_xx,  x~[0,1], t~[0, 1.2]
...
addpath(genpath('/users/labnet5/gr8/buddin/research/project_MMPDE_RIDC/thesis/ridc/code/ridc_be/uniform_mesh/ridc_be/u_f/sourcecode_bf'));
format long
